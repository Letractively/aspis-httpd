...
/************** CGI TYPE (req->is_cgi) ******************/
enum CGI_TYPE { NPH = 1, CGI, PHP };

/***************** ERRORPAGE TYPE **********************/
enum ERRORPAGE_TYPE { ERRORPAGE_400, ERRORPAGE_401, ERRORPAGE_403,
		ERRORPAGE_404, ERRORPAGE_411, ERRORPAGE_412, ERRORPAGE_414,
		ERRORPAGE_416 };
...
struct request {                /* pending requests */
    ...
    char local_ip_addr[ASPIS_NI_MAXHOST]; /* for virtualhost */
    char remote_ip_addr[ASPIS_NI_MAXHOST]; /* after inet_ntoa */
...
extern char *server_root;
extern unsigned short int server_root_len;
extern char *user_dir;
extern char cgi_directory_index[4][MAX_INDEX_NAME_LENGTH];
extern char php_directory_index[4][MAX_INDEX_NAME_LENGTH];
extern char stc_directory_index[4][MAX_INDEX_NAME_LENGTH];
...
extern char *redirect_status;
extern char *php_handler;
extern int php_usage;
...
extern char *v_errorpages[NUM_OF_ERRORPAGES];
