...
/* $Id: aspis.c,v 1.99.2.26 2005/02/22 14:11:29 jnelson Exp $*/
...
static void drop_privs1(void);
static void drop_privs2(void);
...
char *server_root;
unsigned short int server_root_len;
...
#else
        fputs("aspis: don't know where server root is.  Please #define "
              "SERVER_ROOT in aspis.h\n"
 ...
 * Name: set_root
 *
 * Description: Sets the server_root variable and eventualy calls chroot.
 *
 */
